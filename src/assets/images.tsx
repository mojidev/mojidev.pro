...
const images: any = {
  ...
  BackgroundCurveDesktop: new URL(
    "./BackgroundCurveDesktop.svg",
    import.meta.url
  ).href,
  BackgroundCurveMobile: new URL("./BackgroundCurveMobile.svg", import.meta.url)
    .href,
  ...
  IllustrationSproductive: new URL(
    "./IllustrationSproductive.png",
    import.meta.url
  ).href,
